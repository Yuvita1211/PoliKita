...
<?php include 'koneksi.php'?>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php?page=dokter">
          <i class="bi bi-person"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php?page=pasien">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="index.php?page=poli">
