      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">Dr. Sungjin</span>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Daftar Periksa Pasien</h5>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php if ($pasiens["status_periksa"] == 0) { ?>
                        ...
                        <a href="check_pasien.php?page=check_pasien&id=<?php echo $pasiens['id_pasien'] ?>" class="btn btn-success"><i class="fas fa-stethoscope"></i> Check-Up </a>
                        <?php } else { ?>
                          <a href="edit.php?page=edit&id=<?php echo $pasiens['id_periksa'] ?>" class="btn btn-info"><i class="fa fa-edit"></i> Ubah </a>
                      <?php } ?>
                    </td>
                  </tr>
                <?php endforeach; ?>
